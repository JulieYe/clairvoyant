...
//
// Modified:    $ Date: 2013/08/12 00:00:00 $
//
// ID:          $ fye $
//
...
int main(int argc, char ** argv)
{
    ...
    TBDS ts(exchange, contract, multiplier, tickSize, startTradingTime, exitTradingTime, &sc, &logger);
