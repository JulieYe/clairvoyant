...
int main(int argc, char ** argv)
{
    ...
    // reading CTP&ZD api section
    // market data api and trader api
    CZDQHFtdcMdApi *pMdApi = CreateFtdcMdApi(iniconfig.Get("ZDApi", "MdConnectionFolder", "/home/mingyuan/packages/con/Md.CFFEX.con/").c_str());
	...
	if(loggerFolder != "") {
	    ...
	    std::cout << "creating Log file " << loggerFile << std::endl;
    ...
    // ctp part
    std::cout << "registering TraderApi" << std::endl;
    ...
    pTraderApi->Init();
    std::cout << "traderApi initiated" << std::endl;
    ...
    std::cout << "registering MdApi" << std::endl;
    ...
    pMdApi->Init();
    std::cout << "MdApi initiated" << std::endl;
    //pMdApi->Join();
