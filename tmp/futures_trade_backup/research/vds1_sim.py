...
def runFile(filename, log_folder, stop_loss, take_profit, threshold):
    ...
    logfile = os.path.join(log_folder, "vds1_%s.log" % date)
    cmd = "/home/mingyuan/Projects/futures_trade/src/VDS1_sim %s %s %s %s %f %f %f"%(
...
if __name__ == "__main__":
    data_folder = "/home/mingyuan/Projects/futures_trade/data/FeatureData"
    output_folder = "/home/mingyuan/Projects/futures_trade/data/tmp"
